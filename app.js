...
app.get(`/api/weather`, (req, res) => {
    ...
    try  {
        ...
        res.json(weatherData) //sending file as json response to the browser
    }
    catch(err){
        console.log("Error reading weather.json")
        res.status(500)({error: "FAiled to read the file"})
    }
...
app.get(`/api/weather-log`, (req, res) =>{
    ...
    fs.createReadStream(LOG_FILE)
        ...
        //here we send info to the browser as res.json
